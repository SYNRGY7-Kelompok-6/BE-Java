...
public class MutationResponseMapper {
    public AccountInfoResponse toDataDTO(Account account){
    ...
    // ACCOUNT INFO MAPPER
    private DetailAccountInfoResponse toAccountInfoDTO(Account account){
        return DetailAccountInfoResponse.builder()
