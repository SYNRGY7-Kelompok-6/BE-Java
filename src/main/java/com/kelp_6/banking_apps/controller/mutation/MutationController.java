...
import com.kelp_6.banking_apps.service.AccountInfoService;
...
public class MutationController {
    ...
    public WebResponse<AccountInfoResponse> getAccountInfo(
        ...
        AccountInfoResponse accountInfoResponse = accountInfoService.getAccountInfo(request);

        return WebResponse.<AccountInfoResponse>builder()
                .status("success")
